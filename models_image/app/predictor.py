...
# Define the path where models are cached
# Use the baked-in model cache if available, otherwise fall back to default
...
def get_text_classification_pipeline():
    ...
    classifier = pipeline("sentiment-analysis", model="distilbert-base-uncased-finetuned-sst-2-english", cache_dir=HF_CACHE_DIR)
    print("Model loaded.")
    return classifier
